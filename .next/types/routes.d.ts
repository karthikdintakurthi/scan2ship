...
type AppRoutes = "/" | "/admin" | "/admin/add-user" | "/admin/analytics" | "/admin/analytics/clients/[id]" | "/admin/client-configurations" | "/admin/clients" | "/admin/clients/[id]" | "/admin/clients/[id]/edit" | "/admin/credits" | "/admin/register-client" | "/admin/settings" | "/admin/settings/clients/[id]" | "/admin/test" | "/credits" | "/login" | "/orders" | "/settings" | "/test-auth" | "/test-login" | "/test-page" | "/test-pwa" | "/test-ssr" | "/view-orders"
type AppRouteHandlerRoutes = "/api/admin/client-configurations" | "/api/admin/clients" | "/api/admin/clients/[id]" | "/api/admin/clients/[id]/update-password" | "/api/admin/credits" | "/api/admin/credits/[clientId]" | "/api/admin/credits/[clientId]/costs" | "/api/admin/credits/[clientId]/transactions" | "/api/admin/settings/clients/[id]" | "/api/admin/system-config" | "/api/admin/users" | "/api/admin/users/[id]/update-password" | "/api/analytics/clients" | "/api/analytics/clients/[id]" | "/api/analytics/platform" | "/api/analytics/track" | "/api/auth/login" | "/api/auth/register-client" | "/api/auth/register-user" | "/api/auth/verify" | "/api/courier-services" | "/api/credits" | "/api/credits/transactions" | "/api/format-address" | "/api/format-address-image" | "/api/order-config" | "/api/orders" | "/api/orders/[id]" | "/api/orders/[id]/retry-delhivery" | "/api/orders/[id]/shipping-label" | "/api/pickup-locations" | "/api/process-image" | "/api/process-text" | "/api/pwa/manifest" | "/api/test-admin" | "/api/test-clear-cache" | "/api/test-whatsapp" | "/api/users/profile" | "/api/validate-pincode"
