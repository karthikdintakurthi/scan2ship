...
/**
 * Production to QA Database Migration Script using Direct SQL
 * Avoids pg_dump version compatibility issues
 */
...
async function insertRecords(tableName, records) {
  ...
  try {
    ...
    // Get column names from first record (excluding id)
    const firstRecord = records[0];
    const { id, ...columnsWithoutId } = firstRecord;
    const columnNames = Object.keys(columnsWithoutId);
...
async function migrateData() {
  console.log('🚀 Starting Production to QA Database Migration using Direct SQL');
  console.log('================================================================\n');
...
function showHelp() {
  console.log('🔄 Production to QA Database Migration Tool (Direct SQL)');
  console.log('=======================================================\n');
  console.log('Usage:');
  console.log('  node scripts/migrate-prod-to-qa-direct.js [command]\n');
  ...
  console.log('  node scripts/migrate-prod-to-qa-direct.js migrate\n');
